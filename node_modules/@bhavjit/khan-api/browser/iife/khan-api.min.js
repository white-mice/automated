...
`)(He||(He={}));function Ee(t,r){return k(`${b}/getUserByUsernameOrEmail`,He.query,typeof t=="string"?I(t)?{email:t}:{username:t}:t,r)}var je;(r=>r.query=`query getUserHoverCardProfile($kaid: String!) {
  user(kaid: $kaid) {
    id
    nickname
    username
...
`)(je||(je={}));function Ae(t,r){return k(`${b}/getUserHoverCardProfile`,je.query,typeof t=="string"?{kaid:t}:t,r)}var We;(r=>r.query=`query programQuery($programId: String!) {
...
`)(We||(We={}));function Ie(t,r){return k(`${b}/programQuery`,We.query,typeof t=="number"?{programId:t.toString()}:typeof t=="string"?{programId:t}:t,r)}var Ye;(r=>r.query=`query projectsAuthoredByUser($kaid: String, $pageInfo: ListProgramsPageInfo, $sort: ListProgramSortOrder) {
  user(kaid: $kaid) {
    id
