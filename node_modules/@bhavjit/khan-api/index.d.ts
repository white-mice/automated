...
declare const URL_LOCALES: readonly [
  'as',
  'az',
  'cs',
  'da',
...
declare class Client {
   ...
   */
  getUser(
    identifier?: Parameters<typeof this$1.resolveCachedKaid>[0]
  ): Promise<User>
  getAvatar(
    identifier?: Parameters<typeof this$1.resolveCachedKaid>[0] | undefined,
    type?: 'svg' | 'png'
  ): Promise<
    | 'https://www.khanacademy.org/images/avatars/svg/blobby-green.svg'
    | 'https://www.khanacademy.org/images/avatars/svg/blobby-yellow.svg'
...
declare const TypeToClass: {
  readonly COMMENT: typeof TipsAndThanks
  readonly QUESTION: typeof Question
  readonly PROJECT_HELP_QUESTION: typeof Question
}
