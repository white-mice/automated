...
// .yarn/__virtual__/node-fetch-virtual-10f4bc17d9/0/cache/node-fetch-npm-2.6.7-777aa2a6df-8d816ffd1e.zip/node_modules/node-fetch/lib/index.js
...
// .yarn/cache/cross-fetch-npm-3.1.5-e414995db9-f6b8c6ee3e.zip/node_modules/cross-fetch/dist/node-ponyfill.js
...
`
  ...
  ;((ErrorCode2) => {
    ...
    (ErrorCode =
      LoginWithPasswordMutation2.ErrorCode ||
      (LoginWithPasswordMutation2.ErrorCode = {}))
  )
})(LoginWithPasswordMutation || (LoginWithPasswordMutation = {}))
...
var _User = class extends Wrapper {
  ...
  get url() {
    ...
    return `https://www.khanacademy.org/profile/${this.username ?? this.kaid}`
  }
  /**
  ...
  static fromIdentifier(identifier) {
    const user = new _User({
      ...
      username:
        !isKaid(identifier) && !isEmail(identifier) ? identifier : void 0,
  ...
  transformSchema(schema) {
    ...
    return {
      ...
      accessLevel: (_a = schema.profile) == null ? void 0 : _a.accessLevel,
      googleID:
  ...
  async getStatistics(client = this.client ?? new Client()) {
    const statistics = await client.getUserStatistics(
      __privateMethod(this, _resolveIdentifier, resolveIdentifier_fn).call(this)
    )
  ...
  async *getPrograms(client = this.client ?? new Client(), sort, limit) {
    for await (const programs of client.getUserPrograms(
      __privateMethod(this, _resolveIdentifier, resolveIdentifier_fn).call(
        this
      ),
      sort,
      limit
      ...
      programs.forEach((program) => {
        var _a
        return (_a = this.programs) == null ? void 0 : _a.push(program)
      })
      yield programs
    }
    return this
...
var _Program = class extends Wrapper {
  ...
  get url() {
    var _a
    if ((_a = this.rawData) == null ? void 0 : _a.url)
  ...
  get thumbnailUrl() {
    var _a
    if ((_a = this.rawData) == null ? void 0 : _a.imagePath)
  ...
  transformSchema(schema) {
    ...
    return {
      ...
      created: (() => {
        var _a2
        if (!schema.created) return void 0
        if ((_a2 = schema.revision) == null ? void 0 : _a2.created) {
          return new Date(
            Math.min(
      ...
      code: (_a = schema.revision) == null ? void 0 : _a.code,
      hidden: schema.hideFromHotlist,
      type: (() => {
        var _a2
        switch ((_a2 = schema.revision) == null ? void 0 : _a2.editorType) {
          case 'pjs' /* pjs */:
  ...
  async *getTipsAndThanks(client = this.client ?? new Client(), sort) {
    for await (const messages of client.getProgramTipsAndThanks(
      __privateMethod(this, _resolveIdentifier2, resolveIdentifier_fn2).call(
        this
      ),
      sort
    )) {
      ...
      messages.forEach((message) => {
        var _a
        return (_a = this.tipsAndThanks) == null ? void 0 : _a.push(message)
      })
      yield messages
    }
    return this
...
var BaseMessage = class extends Wrapper {
  ...
  get bySelf() {
    var _a
    return ((_a = this.client) == null ? void 0 : _a.user)
      ? this.byUser(this.client.user)
      : false
  }
  transformSchema(schema) {
    return {
      ...
      program: (() => {
        var _a
        if (
          ((_a = schema.focus) == null ? void 0 : _a.kind) ===
...
var MessageType = ((MessageType2) => {
  MessageType2[(MessageType2['TipsAndThanks'] = 'COMMENT') /* COMMENT */] =
    'TipsAndThanks'
  MessageType2[(MessageType2['Question'] = 'QUESTION') /* QUESTION */] =
    'Question'
  MessageType2[
    (MessageType2['HelpRequest'] =
...
var _Message = class extends BaseMessage {
  ...
  get selfVoted() {
    var _a
    if (((_a = this.client) == null ? void 0 : _a.authenticated) === false)
      return null
...
var Question = class extends Message {
  ...
  transformSchema(schema) {
    return {
      ...
      old: schema.isOld,
      answers: (() => {
        if (!schema.answers) return void 0
...
var _Client = class {
  ...
  get kaas() {
    var _a
    if (!this.authenticated || !__privateGet(this, _cookies)) return null
    return (
      ((_a = __privateGet(this, _cookies).match(/KAAS=([^;]+)/)) == null
        ? void 0
        : _a[1]) ?? null
    )
  }
  ...
  async login(identifier, password) {
    ...
    if (password) __privateSet(this, _password, password)
    if (!__privateGet(this, _identifier) || !__privateGet(this, _password)) {
      ...
      if (!__privateGet(this, _password)) throw new Error('Missing password')
    ...
    const json = await __privateMethod(
      (_a = _Client),
      _resolveJsonReponse,
      resolveJsonReponse_fn
    ).call(_a, response)
    ...
    this.kaid =
      typeof ((_b = json.data.loginWithPassword.user) == null
        ? void 0
        : _b.kaid) === 'string' && isKaid(json.data.loginWithPassword.user.kaid)
  ...
  async getUser(identifier) {
    ...
    const response = await getFullUserProfile(
      ...
      !identifier
        ? {
            credentials: 'include',
            headers: { cookie: __privateGet(this, _cookies) },
          }
        : void 0
    )
    const json = await __privateMethod(
  ...
  async getAvatar(
    identifier = this.kaid ?? __privateGet(this, _identifier),
    type = 'svg'
  ) {
    var _a
  ...
  async *getUserPrograms(identifier, sort = 'TOP' /* TOP */, limit = 40) {
    ...
    identifier ??
      (identifier =
        this.kaid ??
        ((_a = this.user) == null ? void 0 : _a.username) ??
        ((_b = this.user) == null ? void 0 : _b.email))
  ...
  async getProgram(identifier) {
    ...
    if (
      this.user &&
      ((_b = program.author) == null ? void 0 : _b.kaid) === this.kaid
    ) {
      program.copy({
        author: this.user,
      })
  ...
  async getMessage(identifier) {
    ...
    if (isTipsAndThanksSchema(messageSchema))
      ...
      if (question.key !== identifier) {
        const answer =
          (_b = question.answers) == null
            ? void 0
            : _b.find((answer2) => answer2.key === identifier)
    ...
    if (
      this.user &&
      ((_c = message.author) == null ? void 0 : _c.kaid) === this.kaid
    ) {
      message.copy({
        author: this.user,
      })
  ...
  async getReply(identifier) {
    ...
    if (
      this.user &&
      ((_b = reply.author) == null ? void 0 : _b.kaid) === this.kaid
    ) {
      reply.copy({
        author: this.user,
      })
  ...
  async *getProgramTipsAndThanks(identifier, sort = 1 /* TopVoted */) {
    yield* this.getProgramMessages(Message.Type.TipsAndThanks, identifier, sort)
  }
  /**
  ...
  async *getProgramQuestions(identifier, sort = 1 /* TopVoted */) {
    yield* this.getProgramMessages(Message.Type.Question, identifier, sort)
  }
  /**
  ...
  async getAllProgramQuestions(identifier, sort = 1 /* TopVoted */) {
    return this.getAllProgramMessages(Message.Type.Question, identifier, sort)
  }
  /**
  ...
  async *getProgramHelpRequests(identifier, sort = 1 /* TopVoted */) {
    yield* this.getProgramMessages(Message.Type.HelpRequest, identifier, sort)
  }
  /**
...
//# sourceMappingURL=khan-api.mjs.map
